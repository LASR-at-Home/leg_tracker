...
class KalmanMultiTracker:
    ...
    def __init__(self):
        ...
        self.non_leg_clusters_pub = rospy.Publisher(
            "non_leg_clusters", LegArray, queue_size=300
        )
        ...
        self.local_map_sub = rospy.Subscriber(
            "local_map", OccupancyGrid, self.local_map_callback
        )
            ...
            for person in self.objects_tracked:
                if person.is_person == True:
                    if (
                        ...
                        marker.color.a = (
                            rospy.Duration(3) - (rospy.get_rostime() - person.last_seen)
